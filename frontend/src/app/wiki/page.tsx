    ...
    <div className="min-h-screen p-8">
      <div className="max-w-4xl mx-auto">
        <PageHeader
          icon="📚"
          title="OSINT Wiki"
          description="Curated directory of OSINT tools, Google Dorks, Shodan queries and more."
        />
        <SearchBar placeholder="Search tools and resources..." onSearch={handleSearch} loading={loading} />
