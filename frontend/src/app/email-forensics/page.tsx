    ...
    <div className="min-h-screen p-8">
      <div className="max-w-4xl mx-auto">
        <PageHeader
          ...
          description="Trace email origins by analyzing raw email headers to reveal the sender's path and IP."
        />
        <SearchBar placeholder="Paste raw email headers..." onSearch={handleSearch} loading={loading} />
