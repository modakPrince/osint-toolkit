    ...
    <div className="min-h-screen p-8">
      <div className="max-w-4xl mx-auto">
        <PageHeader
          ...
          description="Real-time visualization of global cyber threat activity and attack origins."
        />
        <SearchBar placeholder="Search threats by country or type..." onSearch={handleSearch} loading={loading} />
