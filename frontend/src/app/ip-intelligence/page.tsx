    ...
    <div className="min-h-screen p-8">
      <div className="max-w-4xl mx-auto">
        <PageHeader
          ...
          description="Geolocate an IP address and identify its ISP, organization and country."
        />
        <SearchBar placeholder="Enter IP address (e.g. 8.8.8.8)..." onSearch={handleSearch} loading={loading} />
