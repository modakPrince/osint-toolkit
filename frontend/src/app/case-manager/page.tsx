    ...
    <div className="min-h-screen p-8">
      <div className="max-w-4xl mx-auto">
        <PageHeader
          icon="🗂️"
          title="Case Manager"
          description="Save and organize investigation results into exportable case reports."
        />
        <SearchBar placeholder="Enter case name..." onSearch={handleSearch} loading={loading} />
