    ...
    <div className="min-h-screen p-8">
      <div className="max-w-4xl mx-auto">
        <PageHeader
          ...
          description="Detect frameworks, CDNs and server software behind any website."
        />
        <SearchBar placeholder="Enter URL (e.g. https://example.com)..." onSearch={handleSearch} loading={loading} />
